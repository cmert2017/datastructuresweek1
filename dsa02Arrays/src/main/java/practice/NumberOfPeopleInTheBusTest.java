...
public class NumberOfPeopleInTheBusTest {
        NumberOfPeopleInTheBusTest NumberOfPeopleInTheBusTest = new NumberOfPeopleInTheBusTest();

        @Test
        public void test1() {
            ArrayList<int[]> list = generateList();
            assertEquals(solve(list),NumberOfPeopleInTheBus.countPassengers(list));
        }
